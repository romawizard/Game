...
public class MatchesGameActivity extends FragmentActivity {

	private ImageView mBackgroundImage;

	public static void startActivity(Context context) {
		Intent intent = new Intent(context, MatchesGameActivity.class);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mBackgroundImage = (ImageView) findViewById(com.snatik.matches.R.id.background_image);
